...
const TopDoctors = () => {
  ...
  return (
    <div className='flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10'>
        ...
        <button onClick={()=>{navigate('/doctors'); scrollTo(0,0)}} className='bg-gray-200 text-black px-12 py-3 rounded-full mt-10 hover:bg-primary hover:text-white hover:scale-105 transition-all'>more</button>
    </div>
  )
}
